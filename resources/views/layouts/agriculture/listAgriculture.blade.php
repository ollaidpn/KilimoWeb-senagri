    ...
    <body class="vertical-layout vertical-menu-modern navbar-floating footer-static " data-open="click"
        ...
        <div class="app-content content">
            <div class="mb-2 col-xl-12 col-lg-12 col-md-12 col-12" style="">
                <div class="card card-congratulation-medal" style="background-image: url('../assets/kilimo/agro2030-1-big.jpg');background-size: cover;width:100%;height:200px;border-radius:30px;">

                </div>
            </div>
            <a href="{{route('ajouter-agricultures')}}" class="mb-2 btn btn-warning">AJouter</a>
