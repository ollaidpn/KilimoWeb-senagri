  ...
  <body class="vertical-layout vertical-menu-modern navbar-floating footer-static " data-open="click" data-menu="vertical-menu-modern" data-col="">
      ...
      <div class="navbar-container d-flex content">
        ...
        <ul class="ml-auto nav navbar-nav align-items-center">
            ...
            <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
              <li class="dropdown-menu-header">
                <div class="dropdown-header d-flex">
                  <h4 class="mb-0 mr-auto notification-title">My Cart</h4>
                  <div class="badge badge-pill badge-light-primary">4 Items</div>
                </div>
              </li>
              <li class="scrollable-container media-list">
                <div class="media align-items-center"><img class="mr-1 rounded d-block" src="{{asset('assets/admin/images/pages/eCommerce/1.png" alt="donuts" width="62">
                ...
                <div class="media align-items-center"><img class="mr-1 rounded d-block" src="{{asset('assets/admin/images/pages/eCommerce/7.png" alt="donuts" width="62">
                  <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                    <div class="media-heading">
                ...
                <div class="media align-items-center"><img class="mr-1 rounded d-block" src="{{asset('assets/admin/images/pages/eCommerce/2.png" alt="donuts" width="62">
                  <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                    <div class="media-heading">
                ...
                <div class="media align-items-center"><img class="mr-1 rounded d-block" src="{{asset('assets/admin/images/pages/eCommerce/3.png" alt="donuts" width="62">
                  <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                    <div class="media-heading">
                ...
                <div class="media align-items-center"><img class="mr-1 rounded d-block" src="{{asset('assets/admin/images/pages/eCommerce/5.png" alt="donuts" width="62">
                  <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                    <div class="media-heading">
              ...
              <li class="dropdown-menu-footer">
                <div class="mb-1 d-flex justify-content-between">
                  ...
                  <h6 class="mb-0 text-primary font-weight-bolder">$10,999.00</h6>
          ...
          <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder">John Doe</span><span class="user-status">Admin</span></div><span class="avatar"><img class="round" src="{{asset('assets/admin/images/portrait/small/avatar-s-11.jpg" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span></a>
    ...
    <ul class="main-search-list-defaultlist d-none">
      <li class="d-flex align-items-center"><a href="javascript:void(0);">
          <h6 class="mb-0 section-label mt-75">Files</h6></a></li>
      ...
      <li class="d-flex align-items-center"><a href="javascript:void(0);">
          <h6 class="mb-0 section-label mt-75">Members</h6></a></li>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
      <div class="navbar-header">
        <ul class="flex-row nav navbar-nav">
          ...
          <li class="nav-item nav-toggle"><a class="pr-0 nav-link modern-nav-toggle" data-toggle="collapse"><i class="d-block d-xl-none text-primary toggle-icon font-medium-4" data-feather="x"></i><i class="d-none d-xl-block collapse-toggle-icon font-medium-4 text-primary" data-feather="disc" data-ticon="disc"></i></a></li>
        </ul>
      </div>
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="credit-card"></i><span class="menu-title text-truncate" data-i18n="Card">Card</span><span class="ml-auto mr-1 badge badge-light-success badge-pill">New</span></a>
            <ul class="menu-content">
          ...
          <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="pie-chart"></i><span class="menu-title text-truncate" data-i18n="Charts">Charts</span><span class="ml-auto mr-2 badge badge-light-danger badge-pill">2</span></a>
            <ul class="menu-content">
    ...
    <div class="col-xl-8 col-md-6 col-12">
      <div class="card card-statistics">
        <div class="card-header">
          ...
          <div class="d-flex align-items-center">
            <p class="mb-0 card-text font-small-2 mr-25">Updated 1 month ago</p>
          </div>
        </div>
          ...
          <div class="row">
            <div class="mb-2 col-xl-3 col-sm-6 col-12 mb-xl-0">
              <div class="media">
                ...
                <div class="my-auto media-body">
                  <h4 class="mb-0 font-weight-bolder">230k</h4>
                  <p class="mb-0 card-text font-small-3">Sales</p>
                </div>
              </div>
            </div>
            <div class="mb-2 col-xl-3 col-sm-6 col-12 mb-xl-0">
              <div class="media">
                ...
                <div class="my-auto media-body">
                  <h4 class="mb-0 font-weight-bolder">8.549k</h4>
                  <p class="mb-0 card-text font-small-3">Customers</p>
                </div>
              </div>
            </div>
            <div class="mb-2 col-xl-3 col-sm-6 col-12 mb-sm-0">
              <div class="media">
                ...
                <div class="my-auto media-body">
                  <h4 class="mb-0 font-weight-bolder">1.423k</h4>
                  <p class="mb-0 card-text font-small-3">Products</p>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-sm-6 col-12">
              <div class="media">
                ...
                <div class="my-auto media-body">
                  <h4 class="mb-0 font-weight-bolder">$9745</h4>
                  <p class="mb-0 card-text font-small-3">Revenue</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="mb-3 d-sm-flex justify-content-between align-items-center">
              ...
              <div class="d-flex align-items-center">
                <div class="mr-2 d-flex align-items-center">
                  <span class="cursor-pointer bullet bullet-primary font-small-3 mr-50"></span>
                  <span>Earning</span>
                </div>
                <div class="d-flex align-items-center ml-75">
                  <span class="cursor-pointer bullet bullet-warning font-small-3 mr-50"></span>
                  <span>Expense</span>
                </div>
              </div>
            </div>
      ...
      <div class="card card-developer-meetup">
        ...
        <div class="card-body">
          ...
          <div class="avatar-group">
            ...
            >
              <img
                src="{{asset('assets/admin/images/portrait/small/avatar-s-20.jpg')}}"
                alt="Avatar"
                width="33"
                height="33"
              />
      ...
      <div class="card card-browser-states">
        <div class="card-header">
          ...
          <div class="dropdown chart-dropdown">
            <i data-feather="more-vertical" class="cursor-pointer font-medium-3" data-toggle="dropdown"></i>
        ...
        <div class="card-body">
          <div class="browser-states">
            <div class="media">
              <img
                src="{{asset('assets/admin/images/icons/google-chrome.png')}}"
                class="mr-1 rounded"
                height="30"
                alt="Google Chrome"
              />
          ...
          <div class="browser-states">
            <div class="media">
              <img
                src="{{asset('assets/admin/images/icons/mozila-firefox.png')}}"
                class="mr-1 rounded"
                height="30"
                alt="Mozila Firefox"
              />
          ...
          <div class="browser-states">
            <div class="media">
              <img
                src="{{asset('assets/admin/images/icons/apple-safari.png')}}"
                class="mr-1 rounded"
                height="30"
                alt="Apple Safari"
              />
          ...
          <div class="browser-states">
            <div class="media">
              <img
                src="{{asset('assets/admin/images/icons/internet-explorer.png"
                class="mr-1 rounded"
                height="30"
          ...
          <div class="browser-states">
            <div class="media">
              <img src="{{asset('assets/admin/images/icons/opera.png" class="mr-1 rounded" height="30" alt="Opera Mini" />
...
<!-- Dashboard Ecommerce ends -->
  ...
  <!-- Customizer header -->
  <div class="px-2 pt-1 pb-0 customizer-header position-relative">
  ...
  <div class="px-2 customizer-styling-direction">
    <p class="font-weight-bold">Skin</p>
    <div class="d-flex">
      <div class="mr-1 custom-control custom-radio">
        <input
          type="radio"
          id="skinlight"
          name="skinradio"
  ...
  <!-- Menu -->
  <div class="px-2 customizer-menu">
    <div id="customizer-menu-collapsible" class="d-flex">
      <p class="m-0 mr-auto font-weight-bold">Menu Collapsed</p>
      <div class="custom-control custom-control-primary custom-switch">
  ...
  <!-- Layout Width -->
  <div class="px-2 customizer-footer">
  ...
  <!-- Navbar -->
  <div class="px-2 customizer-navbar">
    <div id="customizer-navbar-colors">
      <p class="font-weight-bold">Navbar Color</p>
      <ul class="list-inline unstyled-list">
        <li class="bg-white border color-box selected" data-navbar-default=""></li>
