                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title font-weight-bold mb-1">Bienvenue sur Kilimo! 👋</h2>
                                <p class="card-text mb-2">Connectez-vous pour suivre l'évolution de votre projet !</p>
                                <form class="auth-login-form mt-2" action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex justify-content-between">
                                            <label for="login-password">Mot de passe</label><a
                                                href="{{ route('password.request') }}"><small>Mot de passe oublié
                                                    ?</small></a>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" name="remember" id="remember"
                                                {{ old('remember') ? 'checked' : '' }} type="checkbox" tabindex="3" />
                                ...
                                <p class="text-center mt-2"><span>Pas encore de compte?</span><a
                                        href="{{ route('register') }}"><span>&nbsp;S'inscrire</span></a></p>
