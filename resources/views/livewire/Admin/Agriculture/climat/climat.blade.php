            ...
            <div class="content-wrapper">
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#">Climat</a>
                                        </li>
                                        <li class="breadcrumb-item active"><a href="{{route('admin-type-climat')}}">Type de Climat</a>
                                        </li>
                                    </ol>
                                </div>
                            </div>
                ...
                <div class="content-body">
                    <section id="basic-vertical-layouts">
                        <livewire:admin.agriculture.climat.climat-livewire/>
                    </section>
                </div>
            </div>
        </div>
