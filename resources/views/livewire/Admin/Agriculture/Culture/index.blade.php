    ...
    <div class="content-wrapper">
                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">Spéculation</a>
                                </li>
                                <li class="breadcrumb-item active"><a href="{{route('admin-addCulture')}}">Liste</a>
                                </li>
                            </ol>
                        </div>
                    </div>
        ...
        <div class="content-body">
            <section id="basic-vertical-layouts">
                @include('livewire.Admin.Agriculture.Culture.listCultureIndex')
            </section>
