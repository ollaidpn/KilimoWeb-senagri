...
let elementsAgriculture = document.querySelector('.agriculture')
console.log(elementsAgriculture)
let elementsElevage = document.querySelector('.elevage')
console.log(elementsElevage)
